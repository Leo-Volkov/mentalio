...
const REGEX_EMAIL = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/ // Регулярное выражение для проверки email
...
const validationSchemas = {
	...
	password: Yup.string()
		.required(ERROR_MESSAGES.REQUIRED)
		.matches(REGEX_PASSWORD, ERROR_MESSAGES.PASSWORD_WEAK),
