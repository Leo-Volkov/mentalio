...
import Register
	from '../pages/AuthenticationPages/RegisterPage/Register.jsx'
import PasswordReset
	from '../pages/AuthenticationPages/PasswordResetPage/PasswordReset.jsx'
...
import MyFoldersPage from '../pages/MainPage/pages/MyFoldersPage/MyFoldersPage.jsx'
import AppSwagger from '../AppTest/AppSwagger.jsx'
	...
	return (
		<Router>
			<Routes>
				...
				{/* Маршрут для тестирования Swagger */}
				<Route path="/swagger" element={<AppSwagger/>} />
