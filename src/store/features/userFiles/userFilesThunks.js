...
export const getUserFiles = createAsyncThunk(
	...
	async (_, {rejectWithValue}) => {
		try {
			const response = await axios.get('/userFiles')
			return response.data
		} catch (error) {
			return rejectWithValue(error.response?.data || 'Ошибка при загрузке данных')
		}
	}
)
...
export const createUserFile = createAsyncThunk(
	...
	async (fileData, {rejectWithValue}) => {
		try {
			const response = await axios.post('/userFiles', fileData)
			return response.data
		} catch (error) {
			return rejectWithValue(error.response?.data || 'Ошибка при создании файла')
		}
	}
)
...
export const deleteUserFile = createAsyncThunk(
	...
	async (fileId, {rejectWithValue}) => {
		try {
			...
			return rejectWithValue(error.response?.data || 'Ошибка при удалении файла')
		}
	}
)
...
export const updateUserFile = createAsyncThunk(
	...
	async ({fileId, fileData}, {rejectWithValue}) => {
		try {
			const response = await axios.put(`/userFiles/${fileId}`, fileData)
			return response.data
		} catch (error) {
			return rejectWithValue(error.response?.data || 'Ошибка при обновлении файла')
		}
	}
)
...
export const getFileTopics = createAsyncThunk(
	...
	async (fileId, {rejectWithValue}) => {
		try {
			const response = await axios.get(`/userFiles/${fileId}/topics`)
			return response.data
		} catch (error) {
			return rejectWithValue(error.response?.data || 'Ошибка при получении тем файла')
		}
	}
)
...
export const addTopicToFile = createAsyncThunk(
	...
	async ({fileId, topicData}, {rejectWithValue}) => {
		try {
			const response = await axios.post(`/userFiles/${fileId}/topics`, topicData)
			return response.data
		} catch (error) {
			return rejectWithValue(error.response?.data || 'Ошибка при добавлении темы')
		}
	}
)
...
export const deleteTopicFromFile = createAsyncThunk(
	...
	async ({fileId, topicId}, {rejectWithValue}) => {
		try {
			...
			return rejectWithValue(error.response?.data || 'Ошибка при удалении темы')
		}
	}
)
...
export const getTopicCards = createAsyncThunk(
	...
	async ({fileId, topicId}, {rejectWithValue}) => {
		try {
			const response = await axios.get(`/userFiles/${fileId}/topics/${topicId}/cards`)
			return response.data
		} catch (error) {
			return rejectWithValue(error.response?.data || 'Ошибка при получении карточек темы')
		}
	}
)
...
export const addCardToTopic = createAsyncThunk(
	...
	async ({fileId, topicId, cardData}, {rejectWithValue}) => {
		try {
			const response = await axios.post(`/userFiles/${fileId}/topics/${topicId}/cards`, cardData)
			return response.data
		} catch (error) {
			return rejectWithValue(error.response?.data || 'Ошибка при добавлении карточки')
		}
	}
)
...
export const deleteCardFromTopic = createAsyncThunk(
	...
	async ({fileId, topicId, cardId}, {rejectWithValue}) => {
		try {
			...
			return rejectWithValue(error.response?.data || 'Ошибка при удалении карточки')
		}
	}
)
