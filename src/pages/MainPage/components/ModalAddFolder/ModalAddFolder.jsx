  ...
  return (
    <ModalWrapper isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
      <div className="w-50">
        ...
        <form
          className="w-full sm:w-[490px] flex flex-col gap-[10px] p-3 sm:p-5 bg-directoryFolder rounded-[15px] text-white"
        >
          {/* название папки */}
          <InputAddFolder 
            type={"text"}
          ...
          {
            quantityTopicInput <= 4 && [...Array(quantityTopicInput)].map((_, index) => (
              <InputAddFolder 
                key={index}
                type={"text"}
