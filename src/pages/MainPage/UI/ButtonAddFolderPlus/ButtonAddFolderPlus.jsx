...
import ModalAddFolder from '../../components/ModalAddFolder/ModalAddFolder.jsx'

const ButtonAddFolderPlus = ({isBig = false, myFolderPage = false}) => {
		...
		<>
			{/* Кнопки для открытия модального окна добавления папки */}
			{
				...
				<>
					...
					>
						<FaPlus
							className={`text-primary text-[13px] xs:text-[17px] ${isBig ? 'lg:text-[24px]' : ''}`}/>
					</button>
				</>
			}
...
export default ButtonAddFolderPlus