...
const GroupResetEmail = ({setLevel, setToken_resetPassword, setLogin}) => {
	...
	return (
		<form
			...
			className="w-full xs:w-[490px] mx-auto flex flex-col gap-[20px] md:gap-[40px]"
		>
			<InputAuthCommon
				type="username"
				name="emailOrPhone"
			...
			<div>
				...
				{successMessage ? (
					<div
						className="text-base font-[400] text-[#00C724] text-[12px] sm:text-[16px] text-left mt-[5px] sm:mt-[10px]">
						{successMessage}
					</div>
				) : (
					<div
