...
import GroupResetEmail from './components/GroupResetEmail/GroupResetEmail'
import GroupResetOTP from './components/GroupResetOTP/GroupResetOTP'
import GroupResetPassword
	from './components/GroupResetPassword/GroupResetPassword'
				...
				<div className='flex justify-center items-center min-h-screen'>
					<div className="w-[95%] md:w-[763px] mx-auto text-center">
						...
						<div className="mt-[1.25rem] 2xl:mt-[238px]">
							<h1
								className="text-[32px] md:text-[48px] font-[600] mb-[20px]">Сброс
								пароля</h1>
							{renderLevel}
						</div>
					</div>
