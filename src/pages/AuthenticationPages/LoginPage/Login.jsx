...
import './Login.css'
import InputAuthCommon from '../UI/InputAuthCommon/InputAuthCommon'
			...
			<main className="min-h-screen bg-bgDark text-[#fff]">
				<div className="flex justify-center items-center min-h-screen">
					<div className="w-[95%] sm:w-[763px] mx-auto text-center">
						...
						<LogoCenter/>
						<div
							className="w-[95%] sm:w-[490px] mx-auto mt-[1.25rem] 2xl:mt-[12.5rem]">
							<h1 className="text-[32px] sm:text-[48px] font-[600] mb-[20px]">
								Войти
							</h1>
							<div
								className="text-[14px] sm:text-[20px] font-[400] sm:font-[600] my-[20px]">
								Новый пользователь?
							...
							<form onSubmit={formik.handleSubmit} autoComplete="on">
								...
								<div className="mt-[10px] sm:mt-[20px]">
									...
									/>
									{error && (
										<div className="text-[red] text-xs sm:text-base">
							...
							<div className="text-left mt-[5px] sm:mt-[10px]">
								<Link
									...
									className="text-[#00C724] text-[12px] sm:text-[16px]"
								>
									Забыли пароль?
								</Link>
							</div>
