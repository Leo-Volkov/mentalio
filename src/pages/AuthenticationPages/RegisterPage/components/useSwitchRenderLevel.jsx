...
import CheckboxAuthCommon
	from '../../UI/CheckboxAuthCommon/CheckboxAuthCommon.jsx'
	...
	return useMemo(() => {
		switch (level) {
			...
			case 1:
    				return (
					<div
						className="w-[95%] xs:w-[490px] mx-auto mt-[1.25rem] sm:mt-[1.875rem]">
			...
			case 2:
				return <GroupAvatar avatar={avatars}
