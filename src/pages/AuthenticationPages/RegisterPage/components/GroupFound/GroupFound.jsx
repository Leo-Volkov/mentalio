	...
	return (
		<>
			<div className="w-[95%] mx-auto mt-[60px]">
				<h1
					className="text-[32px] sm:text-[48px] font-[600] mb-[20px] sm:mb-[40px]">Как
					вы нас нашли?</h1>
				
				<div
					className="grid grid-cols-2 sm:grid-cols-3 gap-[10px] md:gap-[10px] 2xl:gap-[40px] mb-[20px] sm:mb-[100px]">
					{
						questions.map(item => (
							<div
